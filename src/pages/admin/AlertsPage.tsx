...
import { AlertsKPICards } from "../../components/admin/alerts/AlertsKPICards";
import { AlertsCharts } from "../../components/admin/alerts/AlertsCharts";
      ...
      <div className="flex items-start justify-between mb-8">
        <div>
          ...
          <p className="text-gray-400 mt-1">
            Monitor high-risk predictions and system notifications
          </p>
        </div>

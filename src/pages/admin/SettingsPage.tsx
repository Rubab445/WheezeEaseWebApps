...
import { ApiIntegrationsSection } from "../../components/admin/settings/ApiIntegrationsSection";
import { SystemConfigSection } from "../../components/admin/settings/SystemConfigSection";
import { DataManagementSection } from "../../components/admin/settings/DataManagementSection";
...
import { UnsavedChangesBar } from "../../components/admin/settings/UnsavedChangesBar";
...
export function SettingsPage() {
  ...
  return (
    <div className="p-8">
      ...
      <div className="flex gap-6">
        ...
        <div className="flex-1 space-y-6">
          {activeSection === "account" && (
            <AccountSection onChange={() => setHasUnsavedChanges(true)} />
          )}
          {activeSection === "security" && (
            <SecuritySection onChange={() => setHasUnsavedChanges(true)} />
          )}
          {activeSection === "notifications" && (
            <NotificationsSection onChange={() => setHasUnsavedChanges(true)} />
          )}
          {activeSection === "api" && (
          ...
          {activeSection === "system" && (
            <SystemConfigSection onChange={() => setHasUnsavedChanges(true)} />
          )}
          {activeSection === "data" && (
          ...
          {activeSection === "appearance" && (
            <AppearanceSection onChange={() => setHasUnsavedChanges(true)} />
          )}
      ...
      {/* Floating Action Bar */}
      {hasUnsavedChanges && (
        <UnsavedChangesBar onSave={handleSave} onDiscard={handleDiscard} />
      )}
    </div>
  );
}

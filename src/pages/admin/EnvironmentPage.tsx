...
import { EnvironmentStatusCards } from "../../components/admin/environment/EnvironmentStatusCards";
import { EnvironmentMap } from "../../components/admin/environment/EnvironmentMap";
import { EnvironmentTrendCharts } from "../../components/admin/environment/EnvironmentTrendCharts";
import { ThresholdAlertsCard } from "../../components/admin/environment/ThresholdAlertsCard";
import { ForecastCard } from "../../components/admin/environment/ForecastCard";
import { LocationsTable } from "../../components/admin/environment/LocationsTable";
import { ApiStatusCard } from "../../components/admin/environment/ApiStatusCard";
import { LocationDetailDrawer } from "../../components/admin/environment/LocationDetailDrawer";
...
export function EnvironmentPage() {
  ...
  const activeLocation =
    mockLocations.find((loc) => loc.isActive) || mockLocations[0];
      ...
      <div className="flex items-start justify-between mb-8">
        <div>
          ...
          <p className="text-gray-400 mt-1">
            Track air quality, pollen, and weather conditions affecting patients
          </p>
        </div>

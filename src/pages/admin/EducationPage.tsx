...
import { EducationStatsCards } from "../../components/admin/education/EducationStatsCards";
import { CategoryFilter } from "../../components/admin/education/CategoryFilter";
import { ContentTypeToggles } from "../../components/admin/education/ContentTypeToggles";
import { ContentGrid } from "../../components/admin/education/ContentGrid";
import { ContentTable } from "../../components/admin/education/ContentTable";
import { ContentDetailDrawer } from "../../components/admin/education/ContentDetailDrawer";
import { AddEditContentModal } from "../../components/admin/education/AddEditContentModal";
import { AnalyticsSection } from "../../components/admin/education/AnalyticsSection";
import { BulkActionsBar } from "../../components/admin/education/BulkActionsBar";
...
const mockContent: EducationalContent[] = [
  {
    ...
    excerpt:
      "Learn about common triggers that can cause asthma symptoms and how to identify your personal triggers for better management.",
    thumbnail:
  ...
  },
  {
    ...
    excerpt:
      "Step-by-step video guide demonstrating proper inhaler technique to ensure you get the full benefit of your medication.",
    thumbnail:
      "https://images.unsplash.com/photo-1584820927498-cfe5211fd8bf?w=400&h=225&fit=crop",
  ...
  },
  {
    ...
    excerpt:
      "Practical tips for reducing exposure to pollen and managing seasonal allergy symptoms effectively.",
    thumbnail:
      "https://images.unsplash.com/photo-1490750967868-88aa4486c946?w=400&h=225&fit=crop",
  ...
  },
  {
    ...
    excerpt:
      "Quick reference guide for what to do during an asthma attack. Download and keep with you at all times.",
    thumbnail:
      "https://images.unsplash.com/photo-1631549916768-4119b2e5f926?w=400&h=225&fit=crop",
    author: { name: "Dr. Sarah Ahmed", avatar: "SA" },
    views: 3892,
    status: "Published",
  ...
  },
  {
    ...
    excerpt:
      "Discover which foods can support your respiratory system and reduce inflammation in your airways.",
    thumbnail:
  ...
  },
  {
    ...
    excerpt:
      "Learn effective breathing techniques that can improve lung capacity and reduce asthma symptoms.",
    thumbnail:
      "https://images.unsplash.com/photo-1599901860904-17e6ed7083a0?w=400&h=225&fit=crop",
    author: { name: "Dr. Ali Khan", avatar: "AK" },
    views: 2156,
    status: "Published",

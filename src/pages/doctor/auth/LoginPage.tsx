...
export function LoginPage({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Show account selector instead of direct login
    ...
    <div className="flex h-screen bg-white overflow-hidden">
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full max-h-[80vh] overflow-y-auto">
            ...
            <div className="p-4 space-y-2">
              {mockAccounts.map((account) => (
                <button
                  ...
                  className="w-full flex items-center gap-4 p-4 rounded-xl border-2 border-gray-200 hover:border-[#059669] hover:bg-[#F0FDF4] transition-all group"
                >
                  {/* Avatar */}
                  ...
                  <div className="flex-1 text-left">
                    <p className="font-bold text-[#1F2937] group-hover:text-[#059669] transition-colors">
                      {account.name}
                    </p>
                  ...
                  {/* Arrow Icon */}
                  <ArrowRight className="w-5 h-5 text-gray-400 group-hover:text-[#059669] transition-colors" />
                </button>
              ))}
            </div>
            ...
            <div className="px-6 py-4 border-t border-gray-200 bg-gray-50">
              <p className="text-sm text-[#6B7280] text-center">
                To continue, WheezeEase will share your name,
                email address, and profile picture with the
                Doctor Portal.
              </p>
            </div>
          </div>
      ...
      <div className="w-1/2 bg-gradient-to-br from-[#F0FDF4] to-[#DCFCE7] relative flex flex-col overflow-hidden">
        ...
        <div className="px-20 py-6 text-center">
          ...
          <p className="text-sm text-[#6B7280]">
            Continue providing exceptional respiratory care
          </p>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-4 py-3.5 text-base border ${errors.email ? "border-red-500" : "border-gray-300"} rounded-lg focus:outline-none focus:ring-2 focus:ring-[#059669] focus:border-transparent transition-all`}
                />
                {errors.email && (
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-12 py-3.5 text-base border ${errors.password ? "border-red-500" : "border-gray-300"} rounded-lg focus:outline-none focus:ring-2 focus:ring-[#059669] focus:border-transparent transition-all`}
                />
                <button
                  type="button"

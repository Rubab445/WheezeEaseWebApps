...
import { ChevronRight, Edit, KeyRound, Ban, Trash2, Calendar, Clock, AlertTriangle, ClipboardList } from 'lucide-react';
import { UserDetailsHeader } from '../components/user-details/UserDetailsHeader';
import { ProfileHero } from '../components/user-details/ProfileHero';
import { TabNavigation } from '../components/user-details/TabNavigation';
import { OverviewTab } from '../components/user-details/OverviewTab';
import { ActivityTab } from '../components/user-details/ActivityTab';
import { AlertsTab } from '../components/user-details/AlertsTab';
import { RoleDetailsTab } from '../components/user-details/RoleDetailsTab';
import { PermissionsTab } from '../components/user-details/PermissionsTab';
    ...
    <div className="p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-400 mt-1">Viewing profile for {currentUser.name}</p>
        </div>

        <div className="flex items-center gap-3">
          <button className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 text-white hover:shadow-lg hover:shadow-purple-500/30 transition-all text-sm" onClick={onEdit}>
      ...
      <div className="mt-6 pb-8">
        ...
        {activeTab === 'permissions' && userRole === 'Doctor' && <PermissionsTab />}
      </div>
    </div>
  );
}